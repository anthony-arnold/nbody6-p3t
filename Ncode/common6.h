...
*
     ...
     &               RZ,TINY,SMAX,WTOT,WTOT0,VRMS,RNSTEPI,RNSTEPR,
     &               E0_ORB,V0_ORB,L0_ORB,RFIN(3),VRFINOLD,DUMMY(88)
...
*
      ...
      COMMON/GPU/    GPUPHI(NMAX),GPUACC(3,NMAX),GPUJRK(3,NMAX),
     &               GF(3,NMAX),GFD(3,NMAX),TINTIR,TINTRE

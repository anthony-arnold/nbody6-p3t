...
*
c          DV(1) = XDOT(1,J) - XDOT(1,I)
c          DV(2) = XDOT(2,J) - XDOT(2,I)
c          DV(3) = XDOT(3,J) - XDOT(3,I)
c          DR2I = 1.0/RIJ2
...
c          FCMD(3) = (DV(3) - A3*DRDV)*DR3I
          DO L = 1,3
             ...
             FPD(L+3) = 0
          END DO
          CALL CUTOFF(X(1,I),XDOT(1,I),X(1,J1),XDOT(1,J1),
     &                FP,FPD,BODY(J1),RS(I))
          CALL CUTOFF(X(1,I),XDOT(1,I),X(1,J2),XDOT(1,J2),
...
c$$$   45     CONTINUE
c$$$*
c$$$*       Evaluate perturbation due to second component.
c$$$          dr2 = 0.0
c$$$          drdv = 0.0
c$$$          DO 46 L = 1,3
c$$$              dx(L) = X(L,J2) - X(L,I)
c$$$              dv(L) = XDOT(L,J2) - XDOT(L,I)
c$$$              dr2 = dr2 + dx(L)**2
c$$$              drdv = drdv + dx(L)*dv(L)
c$$$   46     CONTINUE
c$$$*

...
*       Use c.m. approximation for unperturbed binary.
              ...
              END IF
*
 120          CALL CUTOFF(X(1,I), XDOT(1,I), X(1,J), XDOT(1,J),
     &             FI(1,I), D1(1,I), BODY(J), RS(ICM))
*
...
*       Check optional output for new KS.
     ...
     &                  STEP(ICOMP), SEMI, ECC2
 60       FORMAT (/,' NEW KSREG    TIME =',F9.4,2I10,E12.3,1P,E10.1,

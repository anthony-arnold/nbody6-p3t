...
*
     ...
     &                TCL,STEPCL,NCL,NEWCL
      ...
      SAVE X1,V1,UI,VI,XREL2,VREL2,XS,VS,BODYS,AS,XJ,VJ,BODYJ
*
*
...
*       Print main output diagnostics.
      I6 = TSTAR*TTOT
*
      WRITE (6,40)  TTOT, N, NNB, NPAIRS, NMERGE, MULT, NS, RNSTEPI,
     &              NSTEPB, RNSTEPR, NSTEPU, ERROR, BE(3), ZMASS
   40 FORMAT (//,' T =',F7.0,'  N =',I6,'  <NB> =',I3,'  KS =',I5,
     &           '  NM =',I3,'  MM =',I2,'  NS =',I6,
     &           '  NSTEPS =',E10.2,I10,E10.2,I10,'  DE =',1P,E9.1,
     &           '  E =',0P,F10.6,'  M =',F7.4)
*
      IF (KZ(21).GT.0) THEN
          CALL CPUTIM(TCOMP)

...
*       Choose between small or large run.
      PARAMETER  (NMAX=1050000,KMAX=20000,LMAX=500,MMAX=10,
...
*     PARAMETER  (NMAX=25020,KMAX=1010,LMAX=450,MMAX=10,
*     PARAMETER  (NMAX=20000,KMAX=100,LMAX=500,MMAX=10,
*     PARAMETER  (NMAX=4010,KMAX=1010,LMAX=500,MMAX=10,
